define(['visibleinviewport', 'itemShortcuts', 'browser'], function (visibleinviewport, itemShortcuts, browser) {
    ...
    function loadItemIntoSpotlight(card, item, width) {
        ...
        newCardImageContainer.style.backgroundImage = "linear-gradient(to bottom, rgba(0,0,0,0) 0%,rgba(0,0,0,0.2) 28%,rgba(0,0,0,0.3) 39%,rgba(0,0,0,0.5) 91%,rgba(0,0,0,0.9) 100%), url('" + imgUrl + "')";
